Public Class MMrInstalasi
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        Try
            ...
            ElseIf msg.WParam.ToInt32 = Convert.ToInt32(Keys.Escape) Then
                ...
                Else
                    Dim tny As Integer
                    tny = MessageBox.Show("Mau Keluar dari Master Instalasi ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    If tny = vbYes Then
                        Me.Dispose()
    ...
    Sub tampilData(ByVal row As Integer)
        If DataGridView1.RowCount = 0 Then
            MsgBox("Data Instalasi : Tidak Ada", MsgBoxStyle.Information, "Data Diet")
            txtInstalasi.Text = ""
            btnSearch.Enabled = False
            btnRefresh.Enabled = False
        Else
            ...
            txtInstalasi.Text = DataGridView1.Item(1, row).Value
    ...
    Sub kosong()
        txtInstalasi.Text = ""
    End Sub
    Private Sub MInstalasi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            tanya = MessageBox.Show("Apakah kamu akan menghapus Instalasi : " + txtInstalasi.Text + " ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If tanya = vbYes Then
                statusForm = "DEL"
                kirimData()
                MessageBox.Show("Sukses Delete Data dengan Nama Instalasi : " & txtInstalasi.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
