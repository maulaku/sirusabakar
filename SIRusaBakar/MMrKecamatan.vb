Public Class MMrKecamatan
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        Try
            ...
            ElseIf msg.WParam.ToInt32 = Convert.ToInt32(Keys.Escape) Then
                ...
                Else
                    Dim tny As Integer
                    tny = MessageBox.Show("Mau Keluar dari Master Kecamatan ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    If tny = vbYes Then
                        Me.Dispose()
                    Else
    ...
    Sub tampilData(ByVal row As Integer)
        ...
        Else
            ...
            txtKecamatan.Text = DataGridView1.Item(1, row).Value
