Public Class MMrPendidikan
    ...
    Sub tampilData(ByVal row As Integer)
        ...
        Else
            ...
            txtPendidikan.Text = DataGridView1.Item(1, row).Value
