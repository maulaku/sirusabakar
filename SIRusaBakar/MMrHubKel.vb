Public Class MMrHubKel
    ...
    End Sub
    Sub aktif()
        txtHubKel.Enabled = True
        txtCatatan.Enabled = True

        DataGridView1.Enabled = False
    End Sub
    Sub nonAktif()
        txtHubKel.Enabled = False
    ...
    Sub tampilData(ByVal row As Integer)
        ...
        Else
            ...
            txtHubKel.Text = DataGridView1.Item(1, row).Value
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            TampilDataGrid("SELECT * FROM vwmsHubKel WHERE " & dataCari & " LIKE '%" & txtSearch.Text & "%'")
