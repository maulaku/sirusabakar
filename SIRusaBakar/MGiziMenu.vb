Public Class MGiziMenu
    ...
    Private Sub tampilData(ByVal row As Integer)
        ...
        Else
            ...
            txtKodeMenu.Text = DataGridView1.Item("kodemenumakanan", row).Value
            txtKodeDiet.Text = DataGridView1.Item("kodediet", row).Value
            txtNamaDiet.Text = DataGridView1.Item("namadiet", row).Value
            txtKelompok.Text = DataGridView1.Item("kelompok", row).Value
            cmbWaktu.Text = DataGridView1.Item("waktu", row).Value
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            tanya = MessageBox.Show("Apakah kamu akan menghapus Kode : " + txtKodeMenu.Text + " ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If tanya = vbYes Then
                statusForm = "DEL"
                kirimData()
                MessageBox.Show("Sukses Delete Data dengan Kode COA : " & txtKodeMenu.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                TampilDataGrid("select * from vwmscoa")
                tampilData(0)
            End If
        End If
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If cekdata Then
            ...
            Select Case statusForm
                Case "NEW"
                    MessageBox.Show("Sukses Input Data BARU COA dengan Kode COA : " & txtKodeMenu.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Case "EDIT"
                    MessageBox.Show("Sukses Edit Data LAMA COA dengan Kode COA : " & txtKodeMenu.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End Select
        End If
        TampilDataGrid("select * from vwMsCoa")
        tampilData(0)
