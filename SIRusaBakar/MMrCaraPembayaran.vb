Public Class MMrCaraPembayaran
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        Try
            ...
            ElseIf msg.WParam.ToInt32 = Convert.ToInt32(Keys.Escape) Then
                ...
                Else
                    Dim tny As Integer
                    tny = MessageBox.Show("Mau Keluar dari Master CaraPembayaran ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    If tny = vbYes Then
                        Me.Dispose()
    ...
    End Sub
    Sub aktif()
        txtCaraPembayaran.Enabled = True
        txtCatatan.Enabled = True

        DataGridView1.Enabled = False
    End Sub
    Sub nonAktif()
        txtCaraPembayaran.Enabled = False
    ...
    Sub tampilData(ByVal row As Integer)
        If DataGridView1.RowCount = 0 Then
            MsgBox("Data CaraPembayaran : Tidak Ada", MsgBoxStyle.Information, "Data Diet")
            txtCaraPembayaran.Text = ""
            btnSearch.Enabled = False
            btnRefresh.Enabled = False
        Else
            txtCatatan.Text = ""
            idForm = DataGridView1.Item(0, row).Value
            txtCaraPembayaran.Text = DataGridView1.Item(1, row).Value
    ...
    Sub formatGrid()
        ...
        For Each dc In DataGridView1.Columns
            Select Case dc.Name
                Case "namaCaraPembayaran"
                    dc.HeaderText = "Nama CaraPembayaran"
                    dc.Width = 200
            End Select
        Next
    End Sub
    Sub kosong()
        txtCaraPembayaran.Text = ""
    End Sub
    Private Sub MCaraPembayaran_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try

            tombolHidup()
            nonAktif()
            TampilDataGrid("select * from vwMsCaraPembayaran")
            tampilData(0)
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        kosong()
        aktif()
        txtCaraPembayaran.Focus()
        txtCatatanSebelumnya.Text = ""
    End Sub
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If txtCaraPembayaran.Text = "" Then
            MsgBox("Tidak bisa melakukan delete!", MsgBoxStyle.Information, "Information")
        Else
            Dim tanya As Integer
            tanya = MessageBox.Show("Apakah kamu akan menghapus CaraPembayaran : " + txtCaraPembayaran.Text + " ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If tanya = vbYes Then
                statusForm = "DEL"
                kirimData()
                MessageBox.Show("Sukses Delete Data dengan Nama CaraPembayaran : " & txtCaraPembayaran.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtCaraPembayaran.Text = "" Then
            MsgBox("Data CaraPembayaran Tidak Boleh Kosong !", MsgBoxStyle.Critical, "Simpan Data Gagal")
            Exit Sub
        Else
            kirimData()
            Select Case statusForm
                Case "NEW"
                    MessageBox.Show("Sukses Input Data BARU CaraPembayaran dengan CaraPembayaran : " & txtCaraPembayaran.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Case "EDIT"
                    MessageBox.Show("Sukses Edit Data LAMA CaraPembayaran dengan CaraPembayaran : " & txtCaraPembayaran.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End Select
        End If
        TampilDataGrid("select * from vwMsCaraPembayaran")
        tampilData(0)
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        If cmbSearch.SelectedIndex = 0 Then
            dataCari = "namaCaraPembayaran"
        End If

        If txtSearch.Text = "" Then
            MessageBox.Show("Masukkan data untuk dicari !", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        Else
            TampilDataGrid("SELECT * FROM vwmsCaraPembayaran WHERE " & dataCari & " LIKE '%" & txtSearch.Text & "%'")
    ...
    Private Sub kirimData()
        Try
            PSQL = "EXEC spMsCaraPembayaran" & _
                    " '" & statusForm & "'," & _
                    "  " & idForm & "," & _
                    " '" & txtCaraPembayaran.Text & "'," & _
                    " '" & txtCatatan.Text & "'," & _
                    "  " & idUser & "," & _
                    " '" & keterangan & "'," & _
                    " '" & keterangan & "'"
