Public Class MObatHarga
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.Enabled = False
        posisiForm = "obat_MObatHarga"
        Dim a As New BrowseMaster
        a.Show()
        a.Text = "List Obat"
        a.MdiParent = MainMenu
    End Sub

    Private Sub MObatHarga_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
