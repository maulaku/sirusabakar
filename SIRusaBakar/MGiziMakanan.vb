Public Class MGiziMakanan
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        Try
            ...
            ElseIf msg.WParam.ToInt32 = Convert.ToInt32(Keys.Escape) Then
                ...
                Else
                    Dim tny As Integer
                    tny = MessageBox.Show("Mau Keluar dari Master Makanan ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    If tny = vbYes Then
                        Me.Dispose()
                    Else
    ...
    End Sub
    Sub aktif()
        txtMakanan.Enabled = True
        txtCatatan.Enabled = True

        DataGridView1.Enabled = False
    End Sub
    Sub nonAktif()
        txtMakanan.Enabled = False
    ...
    Sub tampilData(ByVal row As Integer)
        If DataGridView1.RowCount = 0 Then
            MsgBox("Data Makanan : Tidak Ada", MsgBoxStyle.Information, "Data Diet")
            btnSearch.Enabled = False
            btnRefresh.Enabled = False
        Else
            txtCatatan.Text = ""
            idForm = DataGridView1.Item(0, row).Value
            txtMakanan.Text = DataGridView1.Item(1, row).Value
    ...
    Private Sub MGiziDiet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            tombolHidup()
            nonAktif()
            TampilDataGrid("select * from vwMsmakanan")
            tampilData(0)
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            tanya = MessageBox.Show("Apakah kamu akan menghapus Kode : " + txtMakanan.Text + " ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If tanya = vbYes Then
                statusForm = "DEL"
                kirimData()
                MessageBox.Show("Sukses Delete Data dengan Kode Diet : " & txtMakanan.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Select Case statusForm
            Case "NEW"
                MessageBox.Show("Sukses Input Data BARU Diet dengan Kode Diet : " & txtMakanan.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Case "EDIT"
                MessageBox.Show("Sukses Edit Data LAMA Diet dengan Kode Diet : " & txtMakanan.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Select
        TampilDataGrid("select * from vwMsMakanan")
        tampilData(0)
        tombolHidup()
