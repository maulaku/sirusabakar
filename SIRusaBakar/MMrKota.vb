Public Class MMrKota
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        Try
            ...
            ElseIf msg.WParam.ToInt32 = Convert.ToInt32(Keys.Escape) Then
                ...
                Else
                    Dim tny As Integer
                    tny = MessageBox.Show("Mau Keluar dari Master Kota ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    If tny = vbYes Then
                        Me.Dispose()
                    Else
    ...
    Sub tampilData(ByVal row As Integer)
        If DataGridView1.RowCount = 0 Then
            MsgBox("Data Kota : Tidak Ada", MsgBoxStyle.Information, "Data Diet")
            txtKota.Text = ""
            btnSearch.Enabled = False
            btnRefresh.Enabled = False
        Else
            ...
            txtKota.Text = DataGridView1.Item(1, row).Value
    ...
    Sub kosong()
        txtKota.Text = ""
    End Sub
    Private Sub MKota_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Else
            ...
            tanya = MessageBox.Show("Apakah kamu akan menghapus Nama Kota : " + txtKota.Text + " ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If tanya = vbYes Then
                statusForm = "DEL"
                kirimData()
                MessageBox.Show("Sukses Delete Data dengan Nama Kota : " & txtKota.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            TampilDataGrid("SELECT * FROM vwmsKota WHERE " & dataCari & " LIKE '%" & txtSearch.Text & "%'")
